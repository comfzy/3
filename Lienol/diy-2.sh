...
sed -i 's/192.168.1.1/192.168.2.94/g' package/base-files/files/bin/config_generate

# 修改主机名字，把OpenWrt-123修改你喜欢的就行（不能使用中文）
sed -i '/uci commit system/i\uci set system.@system[0].hostname='FZY'' package/default-settings/files/zzz-default-settings
